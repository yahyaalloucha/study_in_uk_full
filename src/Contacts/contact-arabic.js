        ...
        {() => (
          <div className="contact" id="CONTACTS">
            ...
            <div className="contact-container">
              <p className="info-arb">ابقى على تواصل</p>
            </div>
            ...
            <div className="get-container">
              ...
              <strong>
                <p className="get-arb">
                  لا تتردد في سؤالنا عن أي شيء تريده. نحن دائما منفتحون الى
                  المناقشات
                </p>
                <p className="get-arb2">تواصل معنا </p>
                <p className="get-arb3"> :عبر </p>
                <a className="eml-arb" href="mailto:tbestfuture01@gmail.com">
                  مراسلتنا عبر البريد الإلكتروني هنا
                </a>
                <p className="get-arb3-link"> : ناقشنا </p>
                <HashLink
                  className="hash-consolt-arb"
                  smooth
                  to="/Consoltation#Consoltation"
                >
                  <button className="button-consolt-arb">اضغط هنا</button>
                </HashLink>
